...
<br>(Of employee whose details are to be updated)
<br>
<br>
...
<br>
<br>
Enter Employee Ph no.1:<span style='color:red'>*</span>  <input type=textbox name=pno1 style='float:right;color:black' maxlength=10 placeholder=EmployeePhno. required></input>
<br>
<br>
...
<br>
<br>
<input type=submit class="but" value=Update style='border-radius:5px;padding:7px;margin:auto;display:block'></input>
</form>
</div>
</body>
</html>
